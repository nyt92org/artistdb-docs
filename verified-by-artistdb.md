...
hero:
  name: Getting verified by
  text: ArtistDB
  tagline: Benefits of getting verified by ArtistDB and how to get verified
  actions:
    - theme: brand
      text: Learn more
      link: /verified-by-artistdb#what-is-this

features:
  - icon: 📈
    title: Higher visibility
    details: Receives higher visibility on ArtistDB website such as search results, artist list, and frequently listed on the homepage of the website.
  - icon: ✅
    title: More trust & credibility
    details: No more pointing fingers or accusing others of using AI, ArtistDB will help you gain more trust & credibility with your audience by being the third party that helps you verify.
  - icon: 📊
    title: Increasing your reach
    details: Help you reach more audience and get more followers, likes, earnings, and views on your social media.
---

## What is this? {#what-is-this}

![example](/img/verified-example.png)

Verified by ArtistDB is a badge that is given to artists that have been verified by ArtistDB. This badge is given to artists that have gone through the verification process and have been approved by our moderators and admin team. 
